/* 유성에이스 상세페이지 보정 오버레이 (Phase 2)
   - 데스크톱: 상품 이미지 약 56% 확대 (max-height 440 -> 686, +20% 추가, 박스 여백/최소높이 상향)
   - 모바일: 상품 이미지 대폭 확대 (카드 풀블리드 + 여백 최소화 + 86vh, +20% 추가)
...
(function () {
  ...
  var css = ''
    ...
    +   '#up-hero{max-height:686px!important}'
    +   '#up-main div:has(> #up-hero){padding:1.25rem!important;min-height:672px!important}'
    + '}'
    ...
    +   '#up-hero{max-height:86vh!important}'
    + '}';

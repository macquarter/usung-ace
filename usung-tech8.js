...
(function () {
  ...
  function injectStyle() {
    ...
    var css = ''
      ...
      // ── 상단 후드 해부도 히어로 ──
      + '.t8-hero{background:linear-gradient(135deg,#0b1e4d 0%,#123a86 100%);border-radius:26px;'
      +   'padding:30px 30px 26px;margin:0 0 28px;box-shadow:0 24px 52px -30px rgba(11,30,77,.7);}'
      + '.t8-hero-eyebrow{color:#7dd3fc;font-size:12px;font-weight:800;letter-spacing:.24em;'
      ...
      +   'border-radius:50%;background:rgba(125,211,252,.22);color:#7dd3fc;font-size:11px;font-weight:900;'
      +   'display:flex;align-items:center;justify-content:center;}'
      + '.t8-cautions{margin:0;padding:0;}'
      + '.t8-caution{color:#fde68a;font-size:12.5px;line-height:1.55;margin:6px 0 0;'
      +   'padding-left:16px;text-indent:-16px;}'
      // ── 8대 기술 인덱스 ──
      + '.t8-index{background:linear-gradient(135deg,#0b1e4d 0%,#123a86 100%);border-radius:22px;'
      +   'padding:24px 24px 20px;margin:0 0 32px;box-shadow:0 22px 48px -30px rgba(11,30,77,.6);}'
      + '.t8-index-h{color:#7dd3fc;font-size:12px;font-weight:800;letter-spacing:.24em;'
      ...
      +   'border-radius:14px;padding:13px 16px;color:#1e3a8a;font-size:13.5px;font-weight:700;line-height:1.55;}'
